...
TOKEN = '7312596269:AAEPK_B0UpdzEAMyQBNxJ0-i02m8bCHMkQo'
...
FORWARD_CHANNEL_ID = -1002159181973
CHANNEL_ID = -1002159181973
error_channel_id = -1002159181973
...
def handle_message(message):
    ...
    if message.text == "Instant Plan 🧡":
        ...
        bot.send_message(message.chat.id, "*Please use the following link for Canary Download: https://t.me/Raifal404*", parse_mode='Markdown')
